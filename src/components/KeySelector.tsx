...
export const KeySelector = ({ musicKey, setMusicKey }) => {
  ...
  return (
    <div className="text-center -ml-20 text-2xl mb-4">
      <label htmlFor="musicKey">Key</label>
      <div className="text-center focus:border-blue-500 focus:border-10 absolute -mt-10 ml-15 pt-2.5    ">
        <span
      ...
      <select
        ...
        id="musicKey"
        name="Key"
        className="select-none bg-transparent absolute text-center rounded-full z-2 w-12 h-12 ml-2.5 -mt-1 border-2 focus:border-blue-500 focus:border-4 dark:border-white border-gray-800 capitalize text-transparent "
        onChange={(e) => {
